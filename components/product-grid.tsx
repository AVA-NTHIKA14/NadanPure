...
const products = [
  ...
  },
  {
    ...
    description: "Traditional Matta rice from Palakkad",
    price: 85,
    originalPrice: 100,
    purityScore: 97,
    rating: 4.8,
    reviews: 203,
    image: "/images/kerala-red-rice.jpg",
  ...
  },
  {
    id: 7,
    name: "Fresh Tapioca",
    description: "Farm-fresh kappa from Thrissur",
    price: 35,
    originalPrice: 45,
    purityScore: 99,
    rating: 4.6,
  ...
  },
  {
    id: 8,
    name: "Nendran Banana",
    description: "Ripe plantains from Kozhikode",
    price: 55,
    originalPrice: 70,
    purityScore: 98,
    rating: 4.7,
